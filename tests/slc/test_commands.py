...
class CreateItemTest(CliTestCase):
    ...
    def test_create_collection(self) -> None:
        with TemporaryDirectory() as tmp_dir:
            ...
            destination = tmp_path / "sentinel1-slc.json"
            cmd = ["sentinel1", "slc", "create-collection", f"{tmp_path}"]
            ...
            assert collection.id == "sentinel1-slc"
    ...
    def test_create_item(self) -> None:
        item_id = "S1A_IW_SL1__1_SH_20141031T095929_20141031T100002_003072_003842"
        ...
        with self.subTest(granule_href):
            with TemporaryDirectory() as tmp_dir:
                cmd = ["sentinel1", "slc", "create-item", granule_href, tmp_dir]
